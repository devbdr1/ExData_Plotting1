...
# 1
plot(pow_dat$Date_Time, pow_dat$Global_active_power, type="o", pch=NA, ylab="Global Active Power", xlab="")
# 2
plot(pow_dat$Date_Time,pow_dat$Voltage,type="o", pch=NA, ylab="Voltage",xlab="datetime")
#3
...
# 4
plot(pow_dat$Date_Time,pow_dat$Global_reactive_power,type="o", pch=NA, ylab="Global_reactive_power",xlab="datetime")
